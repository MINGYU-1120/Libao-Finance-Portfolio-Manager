              ...
              <div className="space-y-4 animate-in fade-in slide-in-from-top-2">
                 ...
                 <div className="bg-gray-50 p-3 rounded-lg border border-gray-200">
                    <div className="flex items-center justify-between mb-1">
                       <label className="text-xs font-bold text-gray-500 block">台股手續費預設折扣</label>
                       <div className="flex items-center gap-1">
                          <input 
                            type="number"
                            value={twDiscount}
                            onChange={(e) => setTwDiscount(e.target.value)}
                            className="w-12 text-center text-sm font-bold p-1 border rounded focus:ring-1 focus:ring-blue-500 outline-none"
                            placeholder="6"
                          />
