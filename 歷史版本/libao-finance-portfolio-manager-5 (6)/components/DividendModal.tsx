                        ...
                        <div className="flex justify-between items-end pt-2 border-t border-gray-100 bg-gray-50 -mx-4 -mb-4 p-4 rounded-b-xl">
                           <div>
                              ...
                              <div className="font-mono font-medium text-gray-600">
                                 {item.shares > 0 ? item.shares.toLocaleString() : <span className="text-red-400">0</span>}
                              </div>
                           </div>
                    ...
                    {items.map((item, idx) => {
                      ...
                      return (
                        <tr key={item.id} className={`group hover:bg-gray-50 transition-colors ${isSelected ? 'bg-purple-50/20' : ''}`}>
                          ...
                          <td className="p-3 text-right font-mono font-medium text-gray-700 align-middle">
                            {item.shares > 0 ? item.shares.toLocaleString() : (
                                <span className="text-red-400 text-xs">無持倉</span>
                            )}
                          </td>
