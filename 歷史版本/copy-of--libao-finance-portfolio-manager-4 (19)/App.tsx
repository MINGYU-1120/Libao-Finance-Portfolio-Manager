...
const App: React.FC = () => {
  ...
  const tourSteps: TourStep[] = useMemo(() => {
    ...
    const steps: TourStep[] = [
      ...
      ...desktopOnlySteps,
      { targetId: 'tour-news-btn', title: '持股新聞', content: '點擊鈴鐺，自動搜尋您庫存股票的相關最新新聞。' },
      ...
      { targetId: 'detail-header', title: '倉位儀表板', content: '上方顯示此倉位的專屬損益與剩餘現金。' },
      { targetId: 'detail-add-btn', title: '新增交易', content: '點擊「下單」按鈕來記錄買入、賣出或股息。' },
      
      // 4. Order Modal
      { targetId: 'order-modal-content', title: '智慧下單介面', content: '輸入代號與金額，系統會自動計算匯率、手續費與稅金。' },
    ];
    return steps;
  }, [isMobile]);
  ...
  // ... (rest of initial flow control remains same) ...
