        ...
        <div className="p-6 space-y-6">
          ...
          <div className="space-y-3">
            ...
            {enableFees && (
              <div className="space-y-4 animate-in fade-in slide-in-from-top-2">
                 {/* Taiwan Fee Settings - Changed bg-gray-50 to bg-white with shadow/border */}
                 <div className="bg-white p-3 rounded-lg border border-gray-200 shadow-sm">
                    <div className="flex items-center justify-between mb-1">
                       <label className="text-xs font-bold text-gray-600 block">台股手續費預設折扣</label>
                       <div className="flex items-center gap-1">
                          <input 
                            type="number"
                            value={twDiscount}
                            onChange={(e) => setTwDiscount(e.target.value)}
                            className="w-12 text-center text-sm font-bold p-1 border rounded focus:ring-1 focus:ring-blue-500 outline-none bg-white"
                            placeholder="6"
                          />
                          <span className="text-sm font-bold text-gray-600">折</span>
                       </div>
                    </div>
                    <p className="text-[10px] text-gray-400 pl-1">
                       * 若不知道可以詢問營業員 (通常電子下單為 6 折 ~ 2.8 折)
                    </p>
                 </div>

                 {/* US Fee Settings - Changed bg-gray-50 to bg-white with shadow/border */}
                 <div className="bg-white p-3 rounded-lg border border-gray-200 shadow-sm space-y-2">
                    <span className="text-xs font-bold text-gray-600 block">美股預設券商</span>
                    <div className="flex flex-col gap-2">
                        <label className="flex items-center gap-2 text-sm cursor-pointer hover:bg-gray-50 p-1 rounded transition-colors">
                          <input 
                            type="radio" 
                            name="usBroker" 
                            value="Firstrade"
                            ...
                            className="text-blue-600 focus:ring-blue-500 bg-white"
                          />
                          Firstrade (0佣金)
                        </label>
                        <label className="flex items-center gap-2 text-sm cursor-pointer hover:bg-gray-50 p-1 rounded transition-colors">
          ...
          <div className="pt-6 border-t border-gray-200">
              ...
              <button 
                  ...
                  className="w-full py-3 bg-red-600 text-white rounded-lg font-bold hover:bg-red-700 flex items-center justify-center gap-2 transition-colors shadow-lg shadow-red-100"
              >
