  ...
  return (
    <div className="min-h-screen bg-gray-100 pb-20">
              ...
              <div className="flex-1 overflow-y-auto p-6 space-y-8 bg-gray-900">
                 ...
                 <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 gap-2">
                       ...
                       <button onClick={startManualTour} className="w-full flex items-center justify-between p-3.5 rounded-xl bg-blue-500/10 hover:bg-blue-500/20 border border-blue-500/20 transition-all group">
                          <div className="flex items-center gap-3"><HelpCircle className="w-5 h-5 text-blue-400" /><span className="text-sm font-bold text-blue-100">重啟功能導覽教學</span></div>
                 ...
                 <div className="pt-4">
                    <div className="p-4 rounded-xl bg-gradient-to-br from-indigo-600 to-blue-700 text-white shadow-lg">
                       ...
                       <p className="text-[10px] text-blue-100 leading-relaxed mb-3">實現穩定獲利，掌握關鍵持倉比率。如有任何疑問，請聯繫學院助教。</p>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
          {viewMode === 'PORTFOLIO' && (
              <>
                  {/* 手機版/桌機版：戰情室與產業分析僅在「總覽模式」顯示 (!activeCategoryId) */}
                  {!activeCategoryId && (
                          ...
                          <div id="tour-total-capital" className="flex flex-col gap-4">
                              ...
                              <div className="bg-gradient-to-r from-gray-900 to-indigo-900 p-6 rounded-2xl shadow-xl border border-gray-800 relative overflow-hidden">
                                 <div className="relative z-10 flex justify-between items-center">
                                    <div>
                                       <div className="text-indigo-300 text-[10px] sm:text-xs font-bold mb-1 tracking-wider uppercase">總資產淨值 (Total Net Worth)</div>
                                       <div className="text-2xl sm:text-3xl font-mono font-bold text-white tracking-tight">NT$ {maskValue(Math.round(portfolio.totalCapital + calculatedData.totalRealizedPnL + calculatedData.totalUnrealizedPnL).toLocaleString())}</div>
                                    </div>
                              ...
                              <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                                  ...
                                  <div className="bg-white p-4 sm:p-5 rounded-xl shadow-sm border border-gray-200 ring-1 ring-indigo-50 lg:ring-2">
                                     <div className="text-gray-500 text-[10px] font-bold mb-2 uppercase flex items-center gap-1"><Coins className="w-3 h-3 text-indigo-600"/> 可用總現金</div>
                                     <div className="text-base sm:text-xl font-mono font-bold text-indigo-700">
                                         NT$ {maskValue(calculatedData.categories.reduce((acc, c) => acc + c.remainingCash, 0).toLocaleString())}
                                     </div>
                                  </div>
                              </div>
                          </div>
