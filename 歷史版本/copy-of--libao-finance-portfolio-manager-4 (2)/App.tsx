      ...
      if (currentUser) {
        ...
        try {
          ...
          if (cloudData) {
             ...
             // If Local is NEWER than Cloud (e.g., user made changes then refreshed immediately before sync finished)
             // We MUST preserve local data and push it to cloud.
             // Allow 2000ms buffer for clock skew, but generally trust higher timestamp
