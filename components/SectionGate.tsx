                ...
                <div className="relative w-full overflow-hidden group">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-white/90 via-white/60 to-transparent z-10 flex flex-col items-center justify-center text-center p-6">
                        ...
                        <a
                            ...
                            className="px-8 py-3 bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-400 hover:to-yellow-500 text-white font-black rounded-xl shadow-lg shadow-yellow-900/40 transform transition-all hover:scale-105 active:scale-95 border border-yellow-400/20 text-center"
                        >
                            立即升級獲取權限
                        </a>
                    </div>
